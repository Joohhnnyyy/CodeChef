...
Find Middle Element of Linked ListYou are given the head of a singly linked list AAA of length NNN. The values in the list are A1,A2,…,ANA_1, A_2, \ldots, A_NA1​,A2​,…,AN​ respectively. You need to find the value of the middle element of the linked list.
...
Example case 3: The value of the middle element is A3=6A_3=6A3​=6.